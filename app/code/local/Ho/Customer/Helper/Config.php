...
class Ho_Customer_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_COMPLETE_PROFILE_SENDER          = 'ho_customer/complete_profile/sender';
    const XML_PATH_COMPLETE_PROFILE_TEMPLATE        = 'ho_customer/complete_profile/template';
